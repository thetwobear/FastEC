...
public abstract class WebDelegate extends XDelegate implements IWebViewInitializer {
    private WebView mWebView = null;
    private final ReferenceQueue<WebView> WEB_VIEW_QUEUE = new ReferenceQueue<>();
    private String mUrl = null;
    private boolean mIsWebViewAbailable = false;
    private XDelegate mTopDelegate = null;
    ...
    private void initWebView() {
        if (mWebView != null) {
            ...
            if (initializer != null) {
                ...
                final String name = XCore.getConfiguration(ConfigKeys.JAVASCRIPT_INTERFACE);
                mWebView.addJavascriptInterface(JsInterface.create(this), name);
    ...
    public void setTopDelegate(XDelegate delegate) {
        mTopDelegate = delegate;
    }

    public XDelegate getTopDelegate() {
